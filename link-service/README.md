...
- просмотр данных в кеше Redis

➡️ [Скачать demo.mp4](
https://github.com/AndrewAlexeev/linkService/raw/refs/heads/master/demo.mp4)

> Файл хранится через Git LFS (файлы >100 МБ).
> GitHub не показывает его в браузере — только скачивание по ссылке выше.
